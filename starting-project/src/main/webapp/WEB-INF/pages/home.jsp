...
<html>
    <head>
        ...
        <link href="/css/bootstrap-3.2.0.min.css" rel="stylesheet" type="text/css" />
        <link href="/css/font-awesome-4.1.0.min.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        <link href="/css/ionicons-1.5.2.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    <div class="margin text-center">
                        <span>Try our product using your social account</span>
                        <br/>
